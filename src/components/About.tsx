        ...
        <div className="about-grid">
          <Reveal delay={0.1}>
            <div className="about-text">
              <p>{profile.summary}</p>
              <p>
                Interested in roles spanning Data Scientist, ML Engineer, AI Engineer, and GenAI
                Engineer — where model quality, retrieval systems, and production infrastructure
                meet.
              </p>
